---
title: "Supplementary File Text A3"
subtitle: 'Using AMOUNTAIN: step by step'
#author: "Dong Li"
#date: "31 May 2017"
output: pdf_document
---
...
This document shows how to use package  [AMOUNTAIN](http://bioconductor.org/packages/release/bioc/html/AMOUNTAIN.html) step by step. 
...
|KEGG Pathway ID|pathway description|count in gene set|	false discovery rate|
|-----+--------------+-----------------+---------|
