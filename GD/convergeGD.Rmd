...
It is also called Iterative Soft-Thresholding Algorithm (ISTA) or **proximal gradient desent**.
...
Acceleration seems work perfectly, but not all problems are suitable to be accelerated. Even subgradient method has slower convergence rate, it works when the proximal operator is expensive.
