---
title: "A Practical Tutorial on Gene Functional Enrichment Analysis"
author: "Dong Li"
date: 'April 25, 2017'
output:
  html_document:
...
# Introduction
Here is a nice review on enrichment analysis:

> Huang, Da Wei, Brad T. Sherman, and Richard A. Lempicki. "Bioinformatics enrichment tools: paths toward the comprehensive functional analysis of large gene lists." Nucleic acids research 37.1 (2009): 1-13

According to the review, functional enrichment analysis can be categorised into three classes
...
If the p-value $$p$$ is very low (less then 0.05), we can say the candidate gene list $$L$$ is significantly enriched by given GO category $$G$$.
